...
.setDescription(`
\`•\` Ses kanallarında toplam **${Voice}**kişi ve **+${BotVoice} bot** var.
\`•\` Sunucumuz **${TopMember}** kişi ve (**${OnlineUser} kişi aktif.**)
\`•\` Sunucu tagını toplam**${Tagges}** kişi isminde bulundurmakta.
\`•\` Sunucumuzda **${message.guild.premiumSubscriptionCount}** adet boost bulunuyor! (Boost Seviyesi :**${message.guild.premiumTier}.**)`)
