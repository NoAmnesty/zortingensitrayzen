...
if (!SatukeRole) return message.lineReply(SatukEmbed.setDescription(`${Settings.emojiler.iptal} Geçerli bir rol belirtmelisin.(.rolbilgi @rol/ID)`))
...
${SatukeRole} (\`${SatukeRole.id}\`) rolüne ait bilgiler aşağıda verilmiştir.
